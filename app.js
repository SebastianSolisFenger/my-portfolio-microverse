...
const projects = [
  {
    ...
    bigDescription:
      "Seba Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
    imageUrl: "/img/SnapshootPortfolio1.png",
    technologies: ["html", "css", "javaScript", "github", "Ruby", "Bootstrap"],
    linkLive: "https://sebastiansolisfenger.github.io/my-portfolio-microverse/",
    linkSource:
      "https://github.com/SebastianSolisFenger/my-portfolio-microverse",
  },
  {
    ...
    imageUrl: "/img/SnapshootPortfolio2.png",
...
function popUpProject() {
  popupBtns.forEach((projectButton) => {
    projectButton.addEventListener("click", () => {
      ...
      for (
        let i = 0;
        i < projects[projectNumber - 1].technologies.length;
        i += 1
      ) {
